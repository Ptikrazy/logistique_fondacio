...
if (isset($_POST['inscription'])) {
    ...
    inscrire($_SESSION['camp'], $_POST['id_jeune'], $_POST['nom_jeune'], array('creative' => $_POST[$_SESSION['jour_inscription'].'_crea'], 'sportive' => $_POST[$_SESSION['jour_inscription'].'_sport']), $_SESSION['jour_inscription']);
...
?>
    ...
    /*if (in_array($_SESSION['jour_inscription'], array('mardi', 'mercredi', 'jeudi', 'vendredi'))) {
        $non_inscrits = get_non_inscrits($_SESSION['jour_inscription']);
        ...
        $doublons = get_inscrits_doublon($_SESSION['jour_inscription']);
    ...
    if (!empty($_POST['jeune'])) {
        ...
        $id_jeune = $jeune[1];
        $nom_jeune = $jeune[0];
        switch ($_SESSION['jour_inscription']) {
            case 'lundi':
